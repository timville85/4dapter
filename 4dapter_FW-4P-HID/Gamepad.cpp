/*
 * Gamepad.cpp — USB HID gamepad implementation for 4dapter
 *
...
Gamepad_::Gamepad_(void) : PluggableUSBModule(1, 1, epType), protocol(HID_REPORT_PROTOCOL), idle(1), _plugged(false)
{
  epType[0] = EP_TYPE_INTERRUPT_IN;
  _plugged = PluggableUSB().plug(this);
}
